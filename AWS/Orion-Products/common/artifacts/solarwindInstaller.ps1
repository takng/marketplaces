...
#--- START SWIWindowsDefenderExclusions.ps1 ---
...
C:\cfn\artifacts\SolarWinds-Orion-Install.exe /s /ConfigFile="C:\cfn\artifacts\standard.xml"
Start-Sleep 5
$StartTime = $(get-date)
$elapsedTime
...
while(1)
{
    $swInstallationStatus = Get-Process SolarWinds-Orion-Install -ErrorAction SilentlyContinue
    ...
    if ($swInstallationStatus) {
        ...
        write-host "Orion installation Inprogress .... "; [datetime]::Now
        continue;
    }
    else {
